        ...
        <div class="card">
            ...
            <div class="col-md-12">
                <table class="table table-bordered" id='report-list'>
                    ...
                    ?>
                    <tr>
                            <th class="text-center" colspan="5">Bilgi Yok</th>
                    </tr>
                    <?php 
                        endif;
                    ?>
                ...
                <div class="col-md-12 mb-4">
                    <center>
                        <button class="btn btn-success btn-sm col-sm-3" type="button" id="print"><i class="fa fa-print"></i>Yazdır</button>
                    </center>
                </div>
            </div>
            </div>
