...
<div class="modal-footer row display py-1">
		<div class="col-lg-12">
			<button class="btn float-right btn-secondary" type="button" data-dismiss="modal">Kapat</button>
			<button class="btn float-right btn-success mr-2" type="button" id="print">Yazdır</button>
		</div>
</div>
<style>
