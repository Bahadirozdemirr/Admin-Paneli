...
<div class="container-fluid">
	<p class="text-center"><b><?php echo $amount_tendered > 0 ? "Receipt" : "Fatura" ?></b></p>
	<hr>
	<div class="flex">
		<div class="w-100">
			<?php if($amount_tendered > 0): ?>
			<p>Fatura numarası: <b><?php echo $ref_no ?></b></p>
		<?php endif; ?>
			<p>Gün: <b><?php echo date("M d, Y",strtotime($date_created)) ?></b></p>
		</div>
	</div>
	<hr>
	...
	<table width="100%">
		<thead>
			<tr>
				<td><b>QTY</b></td>
				<td><b>Sipariş</b></td>
				<td class="text-right"><b>Miktar</b></td>
			</tr>
		</thead>
		<tbody>
			<?php 
	...
	<hr>
	<p class="text-center"><b>Sipariş Numarası.</b></p>
