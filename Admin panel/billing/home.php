            ...
            <form action="" id="manage-order">
                ...
                <div class="bg-white" id='o-list'>
                            <div class="d-flex w-100 bg-dark mb-1">
                                <label for="" class="text-white"><b>Sipariş No</b></label>
        ...
        <div class="col-lg-8  p-field">
            ...
            <div class="card-footer bg-dark  border-primary">
                <div class="row justify-content-center">
                    <div class="btn btn btn-sm col-sm-3 btn-primary mr-2" type="button" id="pay">Öde</div>
                    <div class="btn btn btn-sm col-sm-3 btn-primary" type="button" id="save_order">Sonra Öde</div>
                </div>
            </div>
            </div>      			
        </div>
...
<div class="modal fade" id="pay_modal" role='dialog'>
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      <div class="modal-content">
        ...
        <h5 class="modal-title"><b>Öde</b></h5>
