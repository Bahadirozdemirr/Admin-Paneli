							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<?php else: ?>
											<span class="badge badge-primary">Ödenmemiş</span>
										<?php endif; ?>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary " type="button" onclick="location.href='billing/index.php?id=<?php echo $row['id'] ?>'" data-id="<?php echo $row['id'] ?>" >Düzenle</button>
										<button class="btn btn-sm btn-outline-primary view_order" type="button" data-id="<?php echo $row['id'] ?>">Gör</button>
										<button class="btn btn-sm btn-outline-danger delete_order" type="button" data-id="<?php echo $row['id'] ?>">Sil</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('#new_order').click(function(){
		uni_modal("Yeni Sipariş ","manage_order.php","mid-large")
		
	})
	$('.view_order').click(function(){
		uni_modal("Sipariş Detayı","view_order.php?id="+$(this).attr('data-id'),"mid-large")
		
	})
	$('.delete_order').click(function(){
		_conf("Silmek istediğine Eminmisin ?","delete_order",[$(this).attr('data-id')])
	})
